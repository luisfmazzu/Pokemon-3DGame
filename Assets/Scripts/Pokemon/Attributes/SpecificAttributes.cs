...
public class SpecificAttributes
{
    ...
    public SpecificAttributes(int _baseLvl, int _natureID, BaseAttributes _baseStats, BaseAttributes _ivs, BaseAttributes _trainedEVs, int _currentHP)
    {
        ...
        this.CalculateAttributes(_baseLvl, _natureID, _baseStats, _ivs, _trainedEVs);
    }

    public void CalculateAttributes(int _baseLvl, int _natureID, BaseAttributes _baseStats, BaseAttributes _ivs, BaseAttributes _trainedEVs)
    {
